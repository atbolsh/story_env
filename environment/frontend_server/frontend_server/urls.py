...
urlpatterns = [
    ...
    # ``sim_code`` may contain dots (e.g. harness names like "qwen3-0.6b"), so the
    # capture group allows ``.`` in addition to word chars and hyphens. \w alone is
    # [A-Za-z0-9_] and would 404 on any sim whose name has a dot.
