...
def revise_identity(persona): 
  ...
  plan_note = chat_single_request(plan_prompt)
  # print (plan_note)

  thought_prompt = statements + "\n"
  thought_prompt += f"Given the statements above, how might we summarize {p_name}'s feelings about their days up to now?\n\n"
  thought_prompt += f"Write the response from {p_name}'s perspective."
  thought_note = chat_single_request(thought_prompt)
  # print (thought_note)
  ...
  new_currently = chat_single_request(currently_prompt)
  # print (new_currently)
  ...
  new_daily_req = chat_single_request(daily_req_prompt)
